...
<head>
    ...
    <title>Register - Audio Translator</title>
    ...
    <div class="max-w-md w-full mx-4">
        ...
        <div class="bg-white shadow-2xl rounded-2xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Become part of Audio Translator</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                           ...
                           name="name" 
                           value="{{ old('name') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent @error('name') border-red-500 @enderror"
                ...
                <!-- Free Account Info -->
                <div class="mb-6 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <i class="fas fa-gift text-gray-600 text-lg"></i>
                        </div>
                        <div class="ml-3">
                            ...
                            <ul class="text-sm text-gray-600 space-y-1">
                                <li class="flex items-center">
                                    ...
                                    2 free audio translations
                                </li>
                                <li class="flex items-center">
                                    <i class="fas fa-check text-gray-500 mr-2"></i>
                                    All 22 languages available
                                </li>
                                <li class="flex items-center">
                                    <i class="fas fa-check text-gray-500 mr-2"></i>
            ...
            <div class="mt-8 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                <h3 class="text-sm font-medium text-gray-900 mb-3">What do you get?</h3>
