                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        ...
                        <label class="relative">
                            <input type="checkbox"
                                   ...
                                   value="{{ $code }}"
                                   class="sr-only peer">
                            <div class="p-3 bg-gray-700/50 border-2 border-gray-600 rounded-lg cursor-pointer transition-all peer-checked:border-blue-500 peer-checked:bg-blue-500/20 hover:border-gray-500">
