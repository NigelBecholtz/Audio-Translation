...
<head>
    ...
    <title>Admin Login - Audio Translator</title>
    ...
    <div class="max-w-md w-full mx-4">
        ...
        <div class="bg-white shadow-2xl rounded-2xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">For administrators only</p>
            </div>
            ...
            <div class="mt-6 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                <div class="flex items-center">
                    ...
                    <p class="text-sm text-gray-700">
                        <strong>Security:</strong> This page is only accessible to administrators with admin rights.
                    </p>
                </div>
            </div>
            ...
            <div class="mt-8 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                <h3 class="text-sm font-medium text-gray-900 mb-3">Admin Features</h3>
