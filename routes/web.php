...
Route::middleware(['auth', 'throttle:60,1'])->group(function () {
    ...
    Route::post('audio/{id}/save-transcription', [AudioController::class, 'saveTranscription'])->name('audio.save-transcription');
    Route::post('audio/{id}/save-translated-text', [AudioController::class, 'saveTranslatedText'])->name('audio.save-translated-text');
