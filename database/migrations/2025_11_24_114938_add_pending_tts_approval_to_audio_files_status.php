...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'mysql' || $driver === 'mariadb') {
            ...
            DB::statement("ALTER TABLE audio_files MODIFY COLUMN status ENUM('uploaded', 'transcribing', 'pending_approval', 'pending_tts_approval', 'translating', 'generating_audio', 'completed', 'failed') DEFAULT 'uploaded'");
            ...
            DB::statement("ALTER TABLE audio_files ADD CONSTRAINT audio_files_status_check CHECK (status IN ('uploaded', 'transcribing', 'pending_approval', 'pending_tts_approval', 'translating', 'generating_audio', 'completed', 'failed'))");
        }
    }
    ...
    public function down(): void
    {
        ...
        if ($driver === 'mysql' || $driver === 'mariadb') {
            // MySQL/MariaDB: Revert to previous ENUM
